...
\paragraph{The level of information granularity affects the \textit{FirstResult} and \textit{DecisionTime}}
...
Individuals facing a higher information overload might not directly experience an information overload while making their choice, because they only concentrate on a part of the given information prior to their decision. In other words, individuals facing an information overload are selective in their information selection and stop \textit{"far short of overloading themselves"} \citep{Jacoby1984}.\\
